/**
 * Модуль для работы с модальным окном удаления данных обучения
 */
const EduDeleteModal = {
    ...
    // === Отправка формы ===
    /**
     * Отправляет запрос на удаление данных обучения
     */
    submitForm: async function () {
        const url = new URL(API_ENDPOINTS.EDU_DELETE);
        this.showSpinner();
        try {
            ...
            console.error('Ошибка при удалении данных обучения:', error);
